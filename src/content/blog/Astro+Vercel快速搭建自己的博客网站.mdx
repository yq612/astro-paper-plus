...
1. 点击 <a href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fyq612%2Fastro-blog&env=GISCUS_REPO,GISCUS_REPO_ID,GISCUS_CATEGORY_ID,GISCUS_lang&envDescription=Giscus%E7%9A%84%E9%85%8D%E7%BD%AE" target="_blank">AstroBlog</a> 创建项目。使用 GitHub 登录，然后创建一个仓库。
...
4. 跳转到腾讯云 DNS 控制台，将刚才复制的 ip，添加解析（不同的供应商操作可能有差异）。
   ...
   操作完成后过几分钟，就可以通过 youside.com 访问你的博客啦！
