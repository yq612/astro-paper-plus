---
title: AstroPaper 添加 Aside 提示组件
author: youquan
pubDatetime: 2023-07-31T16:29:05.569Z
postSlug: AstroPaper 添加 Aside 提示组件
featured: false
draft: false
...
tags:
  ...
  - Aside
  - markdown
description: 为 AstroPaper 添加更加友好的提示组件
---
...
</aside>``` ```bash yarn add remark-directive unist-util-remove
mdast-util-mdx-jsx astro-auto-import
````
